...
function wbps_preview_front_settings_all_settings()
{
    $settings = array(
        'section_title' => array(
            ...
            'type' => 'title',
            'desc' => __(
                '<p class="wbps_settings_info" style="color: black; background-color: #bfe7f5; padding: 10px;">Need to help? <span id="wbps_contact_section_sht" style="display: flex; flex-direction: row;"><button class="btn_wbps_Section" style="margin: 5px; background-color: black; color: white; padding: 5px; border: 0; border-radius: 5px; cursor: pointer;"><a href="https://wpbpreview.com/home/faq/" class="btn_wbps_link" style="text-decoration:none; color:white;" target="_blank">FAQ</a></button><button class="btn_wbps_Section" style="margin: 5px; background-color: black; color: white; padding: 5px; border: 0; border-radius: 5px; cursor: pointer;"><a href="https://wpbpreview.com/home/contact/" target="_blank" style="text-decoration:none; color:white;" class="btn_wbps_link">Get Help</a></button><button class="btn_wbps_Section" style="margin: 5px; background-color: black; color: white; padding: 5px; border: 0; border-radius: 5px; cursor: pointer;"><a href="https://wpbpreview.com/home/contact/" style="text-decoration:none; color:white;" target="_blank" class="btn_wbps_link">Feature Request</a></button></span></p>',
