...
<div id="wbps_<?php echo $product->get_id(); ?>" class="modal fade" tabindex="-1" data-bs-backdrop="static"
    data-bs-keyboard="false" tabindex="-1" aria-labelledby="pdfModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="d-flex justify-content-between w-100 align-items-center">
                    ...
                    <nav class="nav" style="margin-right: 12px;">
                        <a class="border rounded btn-dark btn-sm text-light" id="wbpsPrev"
                            style="cursor:pointer;">prev</a>
                        <a style="cursor:pointer;" class="text-light border rounded btn-dark btn-sm"
                            id="wbpsNext">next</a>
                    </nav>
                </div>
                <svg class="close_button" style="cursor: pointer; height: 25px;" data-bs-dismiss="modal"
                    aria-label="Close" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                    viewBox="0 0 24 24">
    ...
    s0.5-0.1,0.7-0.3c0.4-0.4,0.4-1,0-1.4L13.4,12z" />
            ...
            <div class="modal-body">
                <div id="wbps_limit_reached" class="alert alert-warning" role="alert">
                    Preview Limit reached! Purchase now
                </div>
                <style>
                #wbps_limit_reached {
                    display: none;
            ...
            <div class="modal-footer h-10 d-flex justify-content-between">
                ...
                <a id="aboutBtn" class="btn-dark btn-sm text-light" data-bs-toggle="collapse"
                    data-bs-target="#collapseAuthorDetails" aria-expanded="false"
                    aria-controls="collapseAuthorDetails">About</a>
