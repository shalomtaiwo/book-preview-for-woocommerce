jQuery(function(o) {
  o(document).ready(function() {
    ...
    jQuery(".wbps_popup_btnsimple_pdf")
        .click(function() { elements.addClass("active"); });
    jQuery(".wbps_popup_btnsimple")
        .click(function() { elements.addClass("active"); });

    jQuery(".close-wbps-modal")
        .click(function() { elements.removeClass("active"); });
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  collapseBtn.addEventListener("click", function() {
    if (collapseContent.style.maxHeight) {
      ...
      collapseContent.style.border = 1 + 'px' +
                                     " solid";
    }
  });
});
